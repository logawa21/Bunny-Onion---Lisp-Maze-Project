...
(defparameter *allowed-commands* '(look walk pickup inventory help h cut jump unlock1 unlock2 unlock3 unlock4 eat saw glue ?))
...
(game-use eat salad room2-A4
    ...
    ;; 
    (progn (setf *eaten* 't)
    	'(you have eaten the salad you lose!))
...
;;;;ADD ANOTHER PARENTHESIS AROUND THE NOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOTTTTTTTTTTTTTTTTTTT
(game-action slay weapons dragon hall1-A1
	(cond 
	((not(have 'weapons))
        '(you do not have weapons to slay the dragon with!))
	(t '(you try to slay the dragon but all you end up doing is irritating him! He is too powerful and you get dead. The end.))))


(game-action give salad dragon hall1-A1
	(cond 
	  ((not(have 'salad))
          '(you do not have the salad to give to the dragon!!! HE IS SO HANGRY!!))
          ((equal *eaten* t)
           '(the salad was already eaten.))
        (t (progn (setf *eaten* 't)
	 '(you slowly hand the salad over to the dragon. Will he take it you wonder? GREAT SCOTT! HES A VEGETARIAN!)))))
